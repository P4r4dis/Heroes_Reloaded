...
fclean					:	clean
							...
							@$(MAKE) $(FCLEAN) -C $(EX6_TST_PATH)
							@$(MAKE) $(FCLEAN) -C $(EX6_PATH)
...
tests_run				:	fclean
							...
							@read dummy
							@$(MAKE) test_run_Ex5
							@echo "Press Enter to continue to the next test (Ex6)..."
							@read dummy
							@$(MAKE) test_run_Ex6
							@echo "=====END====="
